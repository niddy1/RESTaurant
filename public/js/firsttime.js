...
function start() {
   if (firstTime(thisPage())) {
      ...
      alert('If you are viewing this on a desktop, please shrink window size. Display is intended for mobile devices. \n \nKitchen Ticket display page is intended for full-size monitors.');
   }
